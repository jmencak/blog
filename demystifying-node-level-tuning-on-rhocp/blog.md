...
[at cluster installation](https://docs.openshift.com/container-platform/4.10/scalability_and_performance/sno-du-enabling-workload-partitioning-on-single-node-openshift.html)
(day 1).
...
[selinux]
avc_cache_threshold=8192      # BZ1548428, PR10027
...
net.ipv4.conf.all.arp_announce=2           # BZ1758552 pod communication due to ARP failures
net.ipv4.neigh.default.gc_thresh1=8192
net.ipv4.neigh.default.gc_thresh2=32768
net.ipv4.neigh.default.gc_thresh3=65536    # BZ1384746 gc_thresh3 limits no. of nodes/routes
net.ipv6.neigh.default.gc_thresh1=8192
net.ipv6.neigh.default.gc_thresh2=32768
net.ipv6.neigh.default.gc_thresh3=65536
vm.max_map_count=262144                    # BZ1793714 ElasticSearch (logging)

[sysfs]
/sys/module/nvme_core/parameters/io_timeout=4294967295    # AWS docs
...
- Adjusting the sizes of netfilter connection tracking hash table and its maximum entries
...
- Enable [more VMs running on RHOCP](https://issues.redhat.com/browse/PSAP-900)
  nodes
- Preventing the TuneD [scheduler] plug-in to align containers to housekeeping CPUs
- Disabling the [dynamic behavior of the TuneD `[scheduler]` plug-in](https://bugzilla.redhat.com/show_bug.cgi?id=1921738)
...
to other latency-sensitive applications.  However, the extra partitioning hRas
